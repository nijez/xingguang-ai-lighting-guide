...
metadata: {"openclaw":{"emoji":"💡","version":"4.0.26","date":"2026-08-14","author":"小馨","company":"深圳市馨光智能物联有限公司"}}
---

# 馨光智能灯控制服务 v4.0.26(本地部署版)
...
用户点名以下场景（含近义/同音说法，如"马尔代夫日落""圣诞氛围""粉红色浪漫"）时，**必须使用下表定稿色对，禁止另行配色**；其他场景才自由设计。
