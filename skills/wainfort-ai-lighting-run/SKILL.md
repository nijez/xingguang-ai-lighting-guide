...
metadata: {"openclaw":{"emoji":"💡","version":"4.0.20","date":"2026-08-14","author":"小馨","company":"深圳市馨光智能物联有限公司"}}
---

# 馨光智能灯控制服务 v4.0.20(本地部署版)
...
把全部候选灯的 did 代入，**一条命令**批量回读开关状态（true=开，false=关）：

```bash
export PATH="$HOME/.local/bin:$PATH"
for did in <did1> <did2> ...; do echo "== $did =="; miloco-cli device props $did prop.2.1 2>/dev/null | grep -o '"value": [a-z]*'; done
```
